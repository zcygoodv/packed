...
//typedef char TCHAR;
//typedef FILE* CHANDLE;
//typedef time_t CFILETIME;
//#endif
...
ZRESULT ZipAddFolder(HZIP hz, const TCHAR* dstzn, TCHAR* src, int len);
...
//     CHANDLE hread,hwrite; CreatePipe(&hread,&hwrite,NULL,0);
//     CHANDLE hthread = CreateThread(0,0,ThreadFunc,(void*)hwrite,0,0);
...
//     CHANDLE hfz = CreateFile("test2.zip",GENERIC_WRITE,0,0,CREATE_ALWAYS,FILE_ATTRIBUTE_NORMAL,0);
//     DWORD writ; WriteFile(hfz,zbuf,zlen,&writ,NULL);
//     CloseHandle(hfz);
//     CloseZip(hz);
//
// (3) Handle use, for file handles and pipes
//     CHANDLE hzread,hzwrite; CreatePipe(&hzread,&hzwrite,0,0);
//     CHANDLE hthread = CreateThread(0,0,ZipReceiverThread,(void*)hzread,0,0);
